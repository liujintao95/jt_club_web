...
function _encodeMessage(message: Message, bb: ByteBuffer): void {
  ...
  // optional string fileSuffix = 10;
  let $fileSuffix = message.fileSuffix;
  if ($fileSuffix !== undefined) {
    writeVarint32(bb, 82);
    writeString(bb, $fileSuffix);
  }

  // optional bytes file = 11;
...
function _decodeMessage(bb: ByteBuffer): Message {
  ...
  end_of_message: while (!isAtEnd(bb)) {
    ...
    switch (tag >>> 3) {
      ...
      // optional string fileSuffix = 10;
      case 10: {
        message.fileSuffix = readString(bb, readVarint32(bb));
        break;
      }
